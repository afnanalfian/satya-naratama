...
class RegencySeeder extends Seeder
{
    public function run()
    {
        $regencies = [
            ...
            ['id'=>1207,'province_id'=>12,'name'=>'Kabupaten Labuhanbatu'],
            ...
            ['id'=>1222,'province_id'=>12,'name'=>'Kabupaten Labuhanbatu Selatan'],
            ['id'=>1223,'province_id'=>12,'name'=>'Kabupaten Labuhanbatu Utara'],
            ...
            ['id'=>1272,'province_id'=>12,'name'=>'Kota Tanjungbalai'],
            ...
            ['id'=>1405,'province_id'=>14,'name'=>'Kabupaten Siak'],
            ...
            ['id'=>1473,'province_id'=>14,'name'=>'Kota Dumai'],
            // -------------------------
            // JAMBI (ID: 15)
            // -------------------------
            ...
            ['id'=>1607,'province_id'=>16,'name'=>'Kabupaten Banyuasin'],
            ...
            ['id'=>1808,'province_id'=>18,'name'=>'Kabupaten Tulang Bawang'],
            ...
            // KEP. RIAU (ID: 21)
            // -------------------------
            ['id'=>2101,'province_id'=>21,'name'=>'Kabupaten Bintan'],
            ['id'=>2102,'province_id'=>21,'name'=>'Kabupaten Karimun'],
            ...
            ['id'=>3176,'province_id'=>31,'name'=>'Kabupaten Kepulauan Seribu'],
            ...
            // -------------------------
            // NUSA TENGGARA TIMUR (ID: 53)
            // -------------------------
            ['id'=>5301,'province_id'=>53,'name'=>'Kabupaten Kupang'],
            ['id'=>5302,'province_id'=>53,'name'=>'Kabupaten Timor Tengah Selatan'],
            ['id'=>5303,'province_id'=>53,'name'=>'Kabupaten Timor Tengah Utara'],
            ['id'=>5304,'province_id'=>53,'name'=>'Kabupaten Belu'],
            ['id'=>5305,'province_id'=>53,'name'=>'Kabupaten Alor'],
            ['id'=>5306,'province_id'=>53,'name'=>'Kabupaten Lembata'],
            ['id'=>5307,'province_id'=>53,'name'=>'Kabupaten Flores Timur'],
            ['id'=>5308,'province_id'=>53,'name'=>'Kabupaten Sikka'],
            ['id'=>5309,'province_id'=>53,'name'=>'Kabupaten Ende'],
            ['id'=>5310,'province_id'=>53,'name'=>'Kabupaten Ngada'],
            ['id'=>5311,'province_id'=>53,'name'=>'Kabupaten Manggarai'],
            ['id'=>5312,'province_id'=>53,'name'=>'Kabupaten Rote Ndao'],
            ['id'=>5313,'province_id'=>53,'name'=>'Kabupaten Manggarai Barat'],
            ['id'=>5314,'province_id'=>53,'name'=>'Kabupaten Sumba Timur'],
            ['id'=>5315,'province_id'=>53,'name'=>'Kabupaten Sumba Barat'],
            ...
            ['id'=>7108,'province_id'=>71,'name'=>'Kabupaten Kepulauan Siau Tagulandang Biaro'],
            ...
            ['id'=>7324,'province_id'=>73,'name'=>'Kabupaten Luwu Timur'],
            ...
            ['id'=>7605,'province_id'=>76,'name'=>'Kabupaten Pasangkayu'],
            ...
            ['id'=>8203,'province_id'=>82,'name'=>'Kabupaten Halmahera Utara'],
            ['id'=>8204,'province_id'=>82,'name'=>'Kabupaten Halmahera Selatan'],
            ['id'=>8205,'province_id'=>82,'name'=>'Kabupaten Kepulauan Sula'],
            ...
            ['id'=>9107,'province_id'=>91,'name'=>'Kabupaten Raja Ampat'],
            ['id'=>9108,'province_id'=>91,'name'=>'Kabupaten Tambrauw'],
            ['id'=>9171,'province_id'=>91,'name'=>'Kota Manokwari'],
            ['id'=>9172,'province_id'=>91,'name'=>'Kota Bintuni'],
            ...
            // PAPUA SELATAN (ID: 95)
            // -------------------------
            ['id'=>9501,'province_id'=>95,'name'=>'Kabupaten Merauke'],
            ['id'=>9502,'province_id'=>95,'name'=>'Kabupaten Mappi'],
            ['id'=>9503,'province_id'=>95,'name'=>'Kabupaten Asmat'],
            ['id'=>9504,'province_id'=>95,'name'=>'Kabupaten Boven Digoel'],

            // -------------------------
            // PAPUA TENGAH (ID: 96)
            // -------------------------
            ['id'=>9601,'province_id'=>96,'name'=>'Kabupaten Nabire'],
            ['id'=>9602,'province_id'=>96,'name'=>'Kabupaten Paniai'],
            ['id'=>9603,'province_id'=>96,'name'=>'Kabupaten Mimika'],
            ['id'=>9604,'province_id'=>96,'name'=>'Kabupaten Puncak'],
            ['id'=>9605,'province_id'=>96,'name'=>'Kabupaten Dogiyai'],
            ['id'=>9606,'province_id'=>96,'name'=>'Kabupaten Deiyai'],

            // -------------------------
            // PAPUA PEGUNUNGAN (ID: 97)
            // -------------------------
            ['id'=>9701,'province_id'=>97,'name'=>'Kabupaten Jayawijaya'],
            ['id'=>9702,'province_id'=>97,'name'=>'Kabupaten Lanny Jaya'],
            ['id'=>9703,'province_id'=>97,'name'=>'Kabupaten Nduga'],
            ['id'=>9704,'province_id'=>97,'name'=>'Kabupaten Tolikara'],
            ['id'=>9705,'province_id'=>97,'name'=>'Kabupaten Yahukimo'],
            ['id'=>9706,'province_id'=>97,'name'=>'Kabupaten Yalimo'],
            ['id'=>9707,'province_id'=>97,'name'=>'Kabupaten Pegunungan Bintang'],

            // -------------------------
            // PAPUA BARAT DAYA (ID: 98)
            // -------------------------
            ['id'=>9801,'province_id'=>98,'name'=>'Kabupaten Sorong'],
            ['id'=>9802,'province_id'=>98,'name'=>'Kabupaten Sorong Selatan'],
            ['id'=>9803,'province_id'=>98,'name'=>'Kabupaten Raja Ampat'],
            ['id'=>9804,'province_id'=>98,'name'=>'Kabupaten Tambrauw'],
            ['id'=>9805,'province_id'=>98,'name'=>'Kabupaten Maybrat'],
            ['id'=>9871,'province_id'=>98,'name'=>'Kota Sorong'],
        ];
