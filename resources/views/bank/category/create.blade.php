        ...
        <div class="bg-white dark:bg-primary-900/30 rounded-2xl border border-primary-100 dark:border-primary-800/30 overflow-hidden shadow-sm">
            ...
            <div class="px-6 py-5 border-b border-primary-100 dark:border-primary-800/30">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-primary-800 dark:text-primary-100">Tambah Kategori</h1>
                        <p class="text-sm text-secondary-500 dark:text-secondary-400">Buat kategori baru untuk bank soal</p>
                    </div>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('bank.category.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="description" rows="5"
                              ...
                              class="w-full px-4 py-3 rounded-xl border border-primary-200 dark:border-primary-700/50 bg-white dark:bg-primary-800/30 text-primary-800 dark:text-primary-50 placeholder-secondary-400 focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all duration-200">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm text-primary-700 dark:text-primary-300">
                                Setelah membuat kategori, Anda dapat menambahkan materi dan soal di dalamnya.
                            </p>
                        </div>
                    </div>
                </div>
