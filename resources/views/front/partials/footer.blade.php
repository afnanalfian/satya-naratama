...
<footer class="bg-black text-white pt-16 pb-8 border-t border-primary/20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="flex items-center gap-4">
                    <div class="h-14 w-14 rounded-full overflow-hidden border-2 border-primary shadow-lg shadow-red-500/20">
                        <img
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-sm">Bimbel Kedinasan TNI POLRI Terpercaya</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 pt-2">
                    <p class="text-gray-400 font-medium">Follow Us:</p>
                    <div class="flex items-center gap-3">
                        ...
                        <a
                            ...
                            class="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#E4405F] transition duration-300 group relative"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            class="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-black transition duration-300 group relative"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            class="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#FF0000] transition duration-300 group relative"
            ...
            <div>
                <h3 class="text-xl font-bold mb-6 pb-3 border-b border-gray-800">
                    Quick Links
                </h3>
                <ul class="space-y-4">
                    <li>
                        <a
                            href="#home"
                            class="flex items-center gap-3 text-gray-400 hover:text-white hover:translate-x-1 transition duration-300 group"
                        >
