    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
            <div class="space-y-2">
                ...
                <p class="text-secondary/70 text-sm md:text-base max-w-lg mt-2">
                    ...
                    @foreach($teachers as $teacher)
                        <div class="snap-start flex-shrink-0 w-72 sm:w-80 lg:w-88">
                            <div class="group relative bg-white rounded-2xl border border-azwara-lighter/60 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 ease-out h-full flex flex-col overflow-hidden">
                                ...
                                <div class="h-1.5 w-full bg-gradient-to-r from-primary via-primary/60 to-primary/30 relative overflow-hidden">
                                ...
                                <div class="p-6 md:p-7 flex flex-col flex-1 relative z-10">
                                    ...
                                    <div class="text-center">
                                        <h3 class="text-lg font-bold text-secondary leading-snug mb-0.5 group-hover:text-primary transition-colors duration-300">
                                            {{ $teacher->user->name }}
                                        </h3>
                                    ...
                                    @if($teacher->bio)
                                        <p class="text-secondary/70 text-sm leading-relaxed text-center flex-1 line-clamp-4">
                                            {{ $teacher->bio }}
                                        </p>
                                    @else
                                        <p class="text-secondary/70 text-sm leading-relaxed text-center flex-1">
                                    ...
                                    <div class="mt-5 pt-4 border-t border-azwara-lighter/40 flex justify-center">
                                        <span class="inline-flex items-center gap-2 text-[10px] font-medium text-secondary/40 uppercase tracking-wider">
        ...
        @else
            <div class="text-center py-20 px-4">
                ...
                <h3 class="text-xl font-bold text-secondary mb-2">Tim Tentor Sedang Disiapkan</h3>
                <p class="text-secondary/70 text-sm max-w-sm mx-auto leading-relaxed">
